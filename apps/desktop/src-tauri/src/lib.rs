...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            get_sync_status,
            set_sync_enabled,
            commands::settings_config::get_exhaustion_policy,
            commands::settings_config::set_exhaustion_policy,
            commands::settings_config::get_fallback_order,
            commands::settings_config::set_fallback_order,
            restart_mcp_server,
            create_skill,
            update_skill,
            delete_skill,
