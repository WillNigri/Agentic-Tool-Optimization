...
#[tauri::command]
fn list_notification_channels(state: State<DbState>) -> Result<Vec<NotificationChannel>, String> {
    let conn = state.0.lock().map_err(|e| e.to_string())?;
...
#[tauri::command]
fn delete_notification_channel(state: State<DbState>, channel_id: String) -> Result<(), String> {
    let conn = state.0.lock().map_err(|e| e.to_string())?;
    conn.execute(
...
#[tauri::command]
fn toggle_notification_channel(state: State<DbState>, channel_id: String, enabled: bool) -> Result<(), String> {
    let conn = state.0.lock().map_err(|e| e.to_string())?;
    conn.execute(
...
#[tauri::command]
async fn test_notification_channel(channel: NotificationChannel) -> Result<NotificationResult, String> {
