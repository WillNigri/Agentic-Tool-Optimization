...
export const mockSkillDetails: Record<string, import('./tauri-api').SkillDetail> = {
  '1': {
    ...
    filePath: '~/.claude/skills/ts-expert/', scope: 'personal', tokenCount: 2340, enabled: true, contentHash: 'abc123', runtime: 'claude', project: null,
  ...
  '2': {
    ...
    filePath: '~/.claude/skills/code-review.md', scope: 'personal', tokenCount: 1890, enabled: true, contentHash: 'def456', runtime: 'claude', project: null,
  ...
  '3': {
    ...
    filePath: '~/.claude/skills/deprecated.md', scope: 'personal', tokenCount: 450, enabled: false, contentHash: 'ghi789', runtime: 'claude', project: null,
  ...
  '4': {
    ...
    filePath: '.claude/skills/conventions.md', scope: 'project', tokenCount: 3200, enabled: true, contentHash: 'jkl012', runtime: 'claude', project: null,
  ...
  '5': {
    ...
    filePath: '.claude/skills/api.md', scope: 'project', tokenCount: 1200, enabled: true, contentHash: 'mno345', runtime: 'claude', project: null,
  ...
  '6': {
    ...
    filePath: '/etc/claude/skills/security-policy.md', scope: 'enterprise', tokenCount: 4100, enabled: true, contentHash: 'ent001', runtime: 'claude', project: null,
  ...
  '7': {
    ...
    filePath: '/etc/claude/skills/compliance.md', scope: 'enterprise', tokenCount: 2800, enabled: true, contentHash: 'ent002', runtime: 'claude', project: null,
  ...
  '8': {
    ...
    filePath: '~/.claude/plugins/eslint-autofix/', scope: 'plugin', tokenCount: 890, enabled: true, contentHash: 'plg001', runtime: 'claude', project: null,
  ...
  '9': {
    ...
    filePath: '~/.claude/plugins/docker-helper.md', scope: 'plugin', tokenCount: 1560, enabled: false, contentHash: 'plg002', runtime: 'claude', project: null,
...
type ProjectFileRefMock = { label: string; path: string; scope: string; exists: boolean; sizeBytes: number; tokenEstimate: number; lastModified: number | null };
type LocalSkillMock = typeof mockSkills[number];
...
export const mockProjectBundle = {
  ...
  ] as ProjectFileRefMock[],
  subagents: [] as ProjectFileRefMock[],
  commands: [] as ProjectFileRefMock[],
  settingsFiles: [
  ...
  codexFiles: [] as ProjectFileRefMock[],
  codexSkills: [] as LocalSkillMock[],
  openclawFiles: [] as ProjectFileRefMock[],
  openclawSkills: [] as LocalSkillMock[],
  hermesFiles: [] as ProjectFileRefMock[],
  hermesSkills: [] as LocalSkillMock[],
  geminiFiles: [] as ProjectFileRefMock[],
  geminiSkills: [] as LocalSkillMock[],
  sandboxConfig: null,
