...
export default function RekeyMasterKeyModal({ onClose, onSuccess }: Props) {
  ...
  // v2.7.15 — Will dogfood 2026-05-22: users don't know what to do
  // with the bare shell command. Click-to-copy + step-by-step gets
  // them from "what's a Terminal?" to "rekey done" in 3 actions.
        ...
        {!result ? (
          <>
            <div className="text-sm text-cs-muted mb-4 space-y-3">
              ...
              {/* Step-by-step instructions — Will dogfood
                  2026-05-22 explicitly asked for this. The bare
                  shell command at the bottom of the modal wasn't
                  enough; users need to know to OPEN Terminal first. */}
              ...
              {/* Recovery path for users who already rotated keys
                  in their system (Will: "I already rotated the keys
