...
export default function WorkstationDispatchCard({ machineName }: Props) {
  ...
  const [runtime] = useState<"claude">("claude");
            ...
            <div className="space-y-2">
              ...
              <div className="grid gap-2">
                {RUNTIME_ENTRIES.filter(([id]) =>
                  ["claude", "codex", "gemini", "openclaw", "hermes"].includes(id),
                ).map(([id, meta]) => {
                  const enabled = id === "claude";
                  ...
                  return (
                    ...
                    >
                      ...
                      {enabled ? (
                        <span className="rounded-full bg-orange-500/20 px-2 py-0.5 text-[10px] font-semibold uppercase text-orange-300">
                          Wave 1
                        </span>
                      ) : (
