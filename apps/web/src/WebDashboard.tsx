...
function LoginPage({ onLogin, onRegister, onGithub }: {
  ...
  // Minimal centered sign-in. Matches the "Linear / Vercel / Claude.ai"
  // pattern: one viewport, focused on the conversion. Marketing copy
  // lives at agentictool.ai; this page is the dashboard entry point,
  // not a duplicate landing.
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white flex flex-col">
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-[#00FFB2]/10 mb-5">
              <span className="text-[#00FFB2] text-xl font-bold tracking-tight">ATO</span>
            </div>
            <h1 className="text-xl font-semibold tracking-tight">
              AI agents that <span className="text-[#00FFB2]">work together</span>.
            </h1>
            <p className="mt-2 text-sm text-[#8888a0]">
              {mode === 'login' ? 'Sign in to your dashboard.' : 'Create your dashboard account.'}
            </p>
          </div>

          {/* Sign-in card */}
          <div className="rounded-xl border border-[#2a2a3a] bg-[#0f0f17] p-6 space-y-5">
            <button
              onClick={onGithub}
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-[#16161e] border border-[#2a2a3a] rounded-lg text-white text-sm hover:bg-[#1d1d28] transition-colors"
            >
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-[11px] uppercase tracking-wider text-[#8888a0]">or</span>
              <div className="flex-1 h-px bg-[#2a2a3a]" />
            </div>
            ...
            <p className="text-center text-sm text-[#8888a0]">
              {mode === 'login' ? (
                <>New here? <button onClick={() => setMode('register')} className="text-[#00FFB2] hover:underline">Sign up</button></>
              ) : (
      ...
      {/* Footer — three subtle links back to the marketing surface, docs, and source. */}
      <footer className="border-t border-[#16161e] py-5 px-6">
        <div className="max-w-sm mx-auto flex items-center justify-center gap-6 text-xs text-[#5a5a6e]">
          <a href="https://agentictool.ai" className="hover:text-[#aaaab8] transition-colors">agentictool.ai</a>
          <a href="https://github.com/WillNigri/Agentic-Tool-Optimization#readme" className="hover:text-[#aaaab8] transition-colors">Docs</a>
          <a href="https://github.com/WillNigri/Agentic-Tool-Optimization" className="hover:text-[#aaaab8] transition-colors">GitHub</a>
        </div>
      </footer>
    </div>
  );
