...
function LoginPage({ onLogin, onRegister, onGithub }: {
  ...
  // Minimal centered sign-in (v2.18). Marketing copy lives at
  // agentictool.ai; this page is the dashboard entry point, not a
  // duplicate landing. Linear / Vercel / Claude.ai pattern: one
  // viewport, focused on the conversion.
  return (
